...
public interface Otp extends Serializable {
	...
	public static abstract class OtpAdapter implements Otp {
		...
		public boolean equals(Object obj) {
			...
			if (clock == null) {
				...
				return false;
			if (delayWindow != other.delayWindow)
				return false;
		...
		public String toString() {
			return "OtpAdapter [clock=" + clock + ", digits=" + digits + ", hash=" + hash
					+ ", delayWindow=" + delayWindow + ", key=***** ]";
		}
	}
