...
public class GTotpTest {
	...
	private final static Logger LOGGER = Logger.getLogger(GTotpTest.class
			.getName());
	...
	public void testUri() throws Exception {
		String name = "john";
		String url = String.format("otpauth://totp/%s?secret=%s", name,
				sharedSecret);
	...
	public void testUriEncoding() throws Exception {
		...
		String url = String.format("otpauth://totp/%s?secret=%s", "john%23doe",
				sharedSecret);
